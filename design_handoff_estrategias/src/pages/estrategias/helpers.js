...
// (ruta A del brief — interpretarPatrones original queda intacta para el Panel).
...
//
// Mapeo tipo → habilidad: identidad. tipo es ya un id del catálogo.
// ─────────────────────────────────────────────────────────────────────
export function buildSugerenciaFromInterpretacion(interpretacion, episodios) {
  ...
  if (!hab) return null; // tipo desconocido: no mostramos sugerencia
...
// Reglas:
//  - Al cerrar (✕), guardar fingerprint + timestamp en Supabase.
//  - Reaparece si: cambia el fingerprint (otra habilidad o episodios distintos)
//                  o pasaron > 14 días desde el descarte.
// ─────────────────────────────────────────────────────────────────────

...
## Cerrado HOY (martes 17 junio 2026) — Diagnósticos de SOLO LECTURA (sin cambios de código): logo de Términos + reconocimiento del loader de carga

**Sesión sin commits de código. Dos tareas de reconocimiento/diagnóstico para preparar pasos siguientes.**
...
**Reemplazamos el wordmark de texto "huella" por el logo real de la marca. Etapas 1 (header) y 2 (pantallas públicas) listas; queda solo la etapa 3 (íconos).**
...
- **PENDIENTE etapa 3 — íconos (único pendiente del frente del logo):** favicon e ícono de app con `logo_2` (solo el escarabajo, sin wordmark).

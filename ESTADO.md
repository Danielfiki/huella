...
- **PRÓXIMO PASO (PENDIENTE OBLIGATORIO, ya registrado arriba):** que los **avances/hitos también alimenten el motor de rasgos** (hoy solo lo nutren los episodios difíciles → el retrato sale sesgado al lado malo y las familias `mueve`/`fortalezas`/`calma` casi no se llenan). Es un cambio de alcance, se aborda como pieza propia con su plan, **antes** de las 4B/4C/4D.
- **PRÓXIMOS PASOS (resto de la pieza 4, después del pendiente obligatorio):**

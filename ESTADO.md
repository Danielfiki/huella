...
## Cerrado HOY — lunes 31 agosto 2026 — **Se cerraron las dos investigaciones abiertas: Ignacia NO era bug, y la hipótesis del Workspace de Vale quedó descartada**

**Día de cierre, sin código.** Las dos incidencias que quedaron abiertas ayer se resolvieron con datos, y las dos terminaron descartando la sospecha inicial.
...
**Frente 1 sigue su curso:** el reloj de los 14 días corre desde el 27 ago, la postulación apunta a **~10 sep**, y lo próximo es **la medición del 2-4 sep, que ahora cubre a las 22 personas**. **El plazo del 31 ago del SDK se cumple hoy y se pasa, como estaba asumido** — desde ahora no se puede subir ninguna actualización nueva a Play hasta que la v4 llegue a producción. *(Recordatorio útil: eso NO bloquea arreglos web, que es como llegó el fix del arranque.)*

...
- ⬜ **ONBOARDING — PASADA EN ANDROID REAL** — desde **3 sep 2026** — el flujo completo está aprobado en PC (claro y oscuro), pero falta verlo en un teléfono Android de 390px: que **A5 con los dos slots de foto de 136px** y **el acto C con sus 6 filas** quepan **sin scroll**, y que la marca de agua del escarabajo no se cruce con el texto en B1. Se prueba con `?onboarding=1` (nada se escribe).
...
- 🧠 **CEREBRO HUELLA — FASE B EN CURSO, PRIORIZADA POR DANIEL (ago 2026)** — desde **24 ago 2026** — un **cerebro 3D manipulable del hijo**. No es una pantalla suelta: es una pieza que vive en cinco lugares. **(a)** card en el Home, *"En el cerebro de {hijo}"*, como **gancho diario**; **(b)** lugar permanente en la **página del hijo**; **(c)** momento contextual dentro de la **orientación post-episodio**; **(d)** **push mensual**; **(e)** **compartible**.
  ...
  - 🔴 **BUG ABIERTO PRIORITARIO — EL TAP AL MODELO 3D NO ABRE LA TARJETA EN ANDROID** — desde **31 ago 2026**, detectado por Daniel **en teléfono real**. **NO investigar ahora: queda anotado.** **Síntoma en una frase: hoy tocas una zona del cerebro en Android/Chrome y la tarjeta no se abre; debería abrirse, como pasa en iPhone.** 🔎 **El detalle que acota el diagnóstico: el raycast SÍ detecta la zona** — al tocar (p. ej.) el cerebelo expuesto, **el chip correspondiente se ilumina**. O sea que **la detección funciona y lo que falla es la apertura de la tarjeta**, no el hit-testing. **Los chips funcionan perfecto en los dos sistemas.** **En iPhone el tap al modelo sí abre la tarjeta** (fue lo que se aprobó en el QA del paso 4). ⚠️ **Sospechoso principal, a revisar cuando se tome: el fix de la deriva (`d46366c` — cuenta de dedos, `pointercancel`, centinela).** Pudo introducir la regresión, y **ese QA fue solo-iPhone**. 🎯 **Prioridad ALTA en la cola del Cerebro: la audiencia de la beta es 100% Android**, así que este bug le pega a todos los testers menos a Daniel.
...
## Cerrado HOY — viernes 4 septiembre 2026 — **El bottom sheet dejó de quedar debajo de la barra: se arregló la raíz en PageTransition, y de paso quedaron cubiertos los 9 overlays sin portal**

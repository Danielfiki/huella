...
## ⏭️ PRIORIDAD INMEDIATA — 🚀 BETA EN CURSO, DÍA 1 (lanzada el domingo 2 ago, una semana antes de lo acordado) · lo único que toca: contar instalaciones

**ESTADO AL 2 AGO 2026 (lo más nuevo, leer primero):** **LA BETA SE LANZÓ HOY.** Los **17 testers** están en el grupo de Google (`testers-huella@huella.lat`, 19 miembros contando `contacto@` y el correo de la prueba de julio), en el grupo de WhatsApp "Huella · Beta", y **cada uno recibió su código por privado** (`HUELLA-01..10` y `HUELLA-13..19`; quedan libres el 11, el 12 y el 20). El link de opt-in se verificó antes de mandarlo.

**LO ÚNICO QUE TOCA AHORA (lunes 3 ago):** **Play Console → Estadísticas → instalaciones.** Contar cuántos instalaron de verdad y, **cuando haya 12 o más, anotar esa fecha en el tablero de `/beta`**. ⚠️ **OJO CON LA CONFUSIÓN MÁS CARA DEL CALENDARIO: el reloj de los 14 días NO arrancó con el lanzamiento — arranca con los 12 instalados simultáneos.** Hoy es el día 1 *del lanzamiento*, no de los 14. **La fecha de término de la beta todavía NO está definida** y depende de ese dato.
...
## Cerrado HOY — domingo 2 agosto 2026 — 🚀 LA BETA SE LANZÓ, UNA SEMANA ANTES DE LO ACORDADO. 17 testers con su código, todos partiendo el mismo día

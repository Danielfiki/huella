...
2. 🟢 **MICRO-RESPUESTA AL "¿CÓMO TE SENTISTE TÚ?" — CAPA (a) CERRADA CON QA el 8 sep 2026** (`d3edf44` + `b06d2ae`): al guardar, aparecen 1 o 2 frases que acompañan lo que el padre escribió, con Haiku, un solo disparo por episodio y marco anti-vergüenza; se ven también al reabrir el episodio. **La capa (b) sigue abierta** (ver más abajo). ⬜ **Antes de volver a tocar el prompt: juntar 10 respuestas reales de testers y revisarlas juntas** — ajustar contra un solo caso lleva a un prompt sobreajustado. 👀 **Patrón a vigilar: la muletilla "especialmente cuando".** Detalle en el bloque del 8 sep. — **Síntoma original: el padre escribía cómo se sintió y no recibía absolutamente nada de vuelta.** Es el único campo de la app que es **solo suyo**, y hoy cae al vacío. Va en **dos capas**:
...
### 4. ✅ PIEZA 2 DE LA COLA — la micro-respuesta al "¿Cómo te sentiste tú?", con MEMORIA (`d3edf44` + `b06d2ae` + `2b`)
...
- ⬜ **ANTES DE VOLVER A TOCAR EL PROMPT: juntar 10 respuestas reales de testers y revisarlas juntas.** Ajustar el tono contra un solo caso es cómo se llega a un prompt sobreajustado que arregla lo último visto y rompe lo demás. 👀 **Patrón a vigilar: la muletilla "especialmente cuando".**

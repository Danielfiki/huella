...
- ✅ **MARCO DE VUELTA EN LOS EPISODIOS — DECIDIDO E IMPLEMENTADO el 4 sep 2026** (camino determinístico, `marcoDelEpisodio` + `PieCientifico` con etiqueta "Lente"). Falta el **QA de Daniel en producción** (episodio nuevo y uno anterior al 27 ago, claro y oscuro). Detalle en el bloque del 4 sep, punto 3.
...
- **DECISIÓN DE DANIEL (mismo día): el marco VUELVE a los episodios, por el camino determinístico. IMPLEMENTADO** (segundo commit del día, pendiente del QA de Daniel en producción):
...
1. **QA de Daniel del lente en episodios** (post-guardado de uno nuevo, y uno anterior al 27 ago desde el Historial; claro y oscuro). Decisión pendiente aparte: "+ Registrar hito" desde el filtro Logros del Historial (sí/no).

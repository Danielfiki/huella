...
3. ⬜ **MOTOR DE RASGOS — LOS HITOS TAMBIÉN DEBEN ALIMENTARLO** — **MUST-HAVE que ya estaba anotado** (ver el bloque del retrato, "EL RETRATO DEBE NUTRIRSE DEL NIÑO COMPLETO"), **reconfirmado en esta posición el 8 sep 2026**. Hoy el motor lee **solo episodios difíciles**, así que el retrato del hijo se dibuja únicamente desde rabietas y desregulación. **Es pieza propia y necesita su plan** antes de tocar código. Se mantiene en este orden a propósito: va **después** de las dos de arriba y **antes** de la entrada única.

...
- **Etapa 4 — EN CURSO · CUENTA GOOGLE PLAY CREADA (4 jul 2026) · IDENTIDAD APROBADA (8 jul 2026):**
  ...
  - **Verificaciones DE GOOGLE** (bloquean el botón **Crear aplicación**):
    ...
    2. ⬜ **Acceso a dispositivo Android — PENDIENTE, en curso:** al entrar a la app móvil **Play Console** con `contacto@huella.lat` da el error *"error durante la carga de tus cuentas de desarrollador"*. Causa probable: **propagación / caché tras la aprobación reciente de identidad**. **Próximo paso:** reintentar tras **actualizar el teléfono y refrescar la app**. (Sigue sin vincular el teléfono; ~5 min cuando cargue bien.)
...
- **Ficha de la store — TEXTOS LISTOS (6 jul 2026):** doc **`huella-ficha-play-store.md`** creado (textos completos + cuestionarios de Play Console + checklist de publicación; vive en el Drive junto a los docs de beta). **Pendiente de la ficha:** **feature graphic 1024×500** (brief a Claude Design) + **capturas de pantalla**.

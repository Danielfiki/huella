...
- 🧠 **CEREBRO HUELLA — FASE B EN CURSO, PRIORIZADA POR DANIEL (ago 2026)** — desde **24 ago 2026** — un **cerebro 3D manipulable del hijo**. No es una pantalla suelta: es una pieza que vive en cinco lugares. **(a)** card en el Home, *"En el cerebro de {hijo}"*, como **gancho diario**; **(b)** lugar permanente en la **página del hijo**; **(c)** momento contextual dentro de la **orientación post-episodio**; **(d)** **push mensual**; **(e)** **compartible**.
  ...
  - ⏭️ **PASO 8 (NUEVO, detrás del paso 7) — los enlaces contextuales desde el MOMENTO.** Desde la orientación IA de un episodio, un enlace al cerebro **con la zona relevante ya abierta**: un episodio de pataleta lleva al cerebro con la **amígdala latiendo y su tarjeta abierta**. Es el gancho que por fin conecta la pieza con **EL MOMENTO**, que es el principio rector del proyecto: hasta acá el cerebro es una enciclopedia bonita: con esto pasa a responder *"¿por qué pasó lo que pasó recién?"*. **Técnicamente el camino está** —la ruta acepta query params y el estado de zona abierta ya existe en `CerebroContenido`—, **lo que falta es el diseño**: cómo se elige la zona desde el texto de la orientación, cómo se entra sin romper el alivio del post-guardado, y cómo se vuelve. **Requiere su propia pasada de producto.**
  - ⏭️ **Antes del 8 va el PASO 7:** QA en la tablet y decisión **GLB v1 vs v2**.
...
## Cerrado HOY — jueves 27 agosto 2026 — **DÍA SIN CÓDIGO: el Frente 1 avanzó dos de sus tres pasos, y la ventana de 14 días por fin arrancó**

**Cero commits de código.** El trabajo del día fue de Daniel, en Play Console y en WhatsApp — que es exactamente lo que el 26 ago se acordó que iba primero: *"esto va ANTES que cualquier código, porque es lo único que tiene reloj y no depende de nosotros"*.
...
**El Cerebro Huella (pasos 7 y 8) sigue en paralelo y no bloquea nada.**

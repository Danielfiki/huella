...
3. ✅ **HECHO Y AMPLIADO — se reclutaron 7 testers nuevos.** **5 el 29 ago** (entraron al grupo, recibieron código y mensaje) **+ 2 el 31 ago** (`rlazod`, `sfaille` — ya en el grupo; mensajes y códigos salen ese día). La lista oficial pasó de 18 a **22 personas**. Detalle en los bloques del 29 y del 31 ago.
...
1. **Medir la actividad en la ventana 2-4 sep** (día ~7 del reloj), **sobre las 22 personas**, con las queries de métricas cruzadas contra la **LISTA OFICIAL DE TESTERS** de la sección de abajo (esa tabla manda: son **22 personas**, y si un número no cuadra, manda la tabla). Antes del 2 sep el dato no sirve: son pocos días y cae en fin de semana.
...
**Son 22 personas (actualizado el 31 ago 2026).** La cuenta: eran **18** al 11 ago, **− 3 que nunca respondieron** (`be.delacerda`, `snackclub2022`, `nicolas.arriagada` — sus códigos `H-01`, `H-06` y `H-09` se reciclaron el 29 ago tras verificar por query que seguían sin canjear), **+ 5 testers nuevos el 29 ago** = 20, **+ 2 más el 31 ago** (`rlazod` y `sfaille`) = **22**.

*Historia del número, para que no se vuelva a enredar: los 17 del lanzamiento (2 ago) **+ la mamá** (`nene.pepita`, 5 ago) = 18, **− Nicole** (falta de espacio en el teléfono) = 17, **+ Nicolás Arriagada** = 18, y de ahí a los 20 de hoy. En días anteriores del archivo quedó escrito "17" en varios lados porque cada movimiento se anotó por separado y nunca se rehízo la suma.*
...
| # | Nombre | Correo | Código confirmado | Estado al 29 ago |
|---|---|---|---|---|
...
| 5 | Pia Heap | `pia.heap@gmail.com` | — | con cuenta |
| 6 | Matias Cartagena | `matias.lagos.cartagena@gmail.com` | — | con cuenta |
| 7 | Paulina Moraga | `paulinajmg.88@gmail.com` | — | con cuenta |
| 8 | Tomas Vergara | `tomas.vergara88@gmail.com` | — | con cuenta |
| 9 | Vale Ramirez | `v.ramirez@pacificschoolpichilemu.com` | H-13 | 🟡 **registrada, SIN canjear** |
| 10 | Cata Grez | `catagrez9363@gmail.com` | — | con cuenta |
| 11 | Javi Zamora | `javiera.zamora.r@gmail.com` | H-17 | 🟡 **registrada, SIN canjear** |
| 12 | Max Lund | `mlundv@gmail.com` | — | con cuenta |
| 13 | Igna | `ignacopardo@gmail.com` | H-15 | ✅ **canjeado (31 ago)** · ⬜ falta que abra Play desde SU teléfono |
| 14 | Anita Gomez | `amgomezsc1@gmail.com` | — | con cuenta |
| 15 | Mama | `nene.pepita@gmail.com` | H-11 | 🟡 **registrada, SIN canjear** |
| 16 | Krishna Baquedano | `krishna.baquedano77@gmail.com` | **H-06** | nueva (29 ago) — código reciclado |
| 17 | Maria Adriana | `mariaadrianaq@gmail.com` | **H-01** | nueva (29 ago) — código reciclado · ⚠️ incidencia de acceso abierta |
| 18 | Carolina Morales | `calomose@gmail.com` | **H-09** | nueva (29 ago) — código reciclado |
| 19 | Constanza Aguayo | `conny.aguero@gmail.com` | **H-12** | nueva (29 ago) |
| 20 | Iti Fuenzalida | `snnunez1@gmail.com` | **H-26** | nueva (29 ago) — primera del lote 2 |
| 21 | **Rodrigo Lazo** | `rlazod@gmail.com` | **H-27** | 🆕 nuevo (31 ago) — en el grupo; mensaje y código salen hoy |
| 22 | **Titi Scout** | `sfaille@gmail.com` | **H-28** | 🆕 nueva (31 ago) — en el grupo; mensaje y código salen hoy |

*Notas de la tabla: **(a)** la columna de código trae solo los **confirmados** (los que no canjearon y los 7 nuevos); el resto de la asignación vive en el tablero de `/beta`, que es estado local del navegador y **no** la base — por eso van en "—". **(b)** ✅ **Los nombres que faltaban quedaron completos el 31 ago** — la tabla ya no tiene huecos. **(c)** Salieron de la lista `be.delacerda`, `snackclub2022` y `nicolas.arriagada` — nunca respondieron y sus códigos se reciclaron el 29 ago.*
...
**Los dos quedaron agregados al grupo de Google el 31 ago.** Los mensajes de bienvenida y los códigos **los envía Daniel hoy**. La lista oficial pasó de **20 a 22 personas**, y la tabla de arriba está actualizada.
...
**Ojo con el colchón, que es el punto de todo esto:** con 22 personas hay **10 de margen** sobre los 12 que exige Google. El requisito es de **12 SIMULTÁNEOS**, así que el margen es contra desinstalaciones, no un acumulado.
...
**🥇 FRENTE 1 — LA VENTANA DE MEDICIÓN ARRANCA EL MIÉRCOLES 2 DE SEPTIEMBRE, y es lo PRIMERO del proyecto: va antes incluso del QA del onboarding.** El reloj de los 14 días corre desde el 27 ago y la postulación apunta a **~10 sep**, así que la medición del **2-4 sep** (día ~7) es la que dice si hay que empujar a alguien antes de postular. Se mide contra la **LISTA OFICIAL DE TESTERS**, que hoy tiene **22 personas**.
...
2. **Monitorear la actividad de los actuales**, con las queries de métricas cruzadas contra la **LISTA OFICIAL DE TESTERS** (18 personas; si un número no cuadra, manda la tabla).

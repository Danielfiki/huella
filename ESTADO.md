...
### Logo de marca — FRENTE COMPLETO: etapas 1, 2 y 3 CERRADAS (header + pantallas públicas + íconos)

**Reemplazamos el wordmark de texto "huella" por el logo real de la marca. Etapas 1 (header), 2 (pantallas públicas) y 3 (favicon + íconos PWA) CERRADAS y verificadas en producción.** *(El dibujo del logo se actualizó el 17 junio, commit `f7ad2b6`, verificado en prod; las etapas 1 y 2 quedaron con el dibujo nuevo.)* **Siguiente: etapa 4 (sembrar el escarabajo en momentos clave dentro de la app) — ver al final de esta subsección.**
...
- **El FRENTE DEL LOGO (etapas 1, 2 y 3) queda COMPLETO.**

**Próximo paso — ETAPA 4 del logo (PENDIENTE):** sembrar el **escarabajo solo** en momentos clave dentro de la app, como guiño de marca:
- **Avatares "h" de Huella** en el feed de análisis (donde hoy aparece una "h" como autor/marca).
- **Latido del círculo** en los loaders de proceso (el escarabajo como elemento vivo mientras algo carga).
- **Arranca con una auditoría** de **dónde aparece hoy la "h"** (y los puntos de "marca" dentro de la app) para decidir dónde calza el escarabajo sin recargar.

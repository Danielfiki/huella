...
**1. Todo overlay de pantalla completa va por `createPortal` a `document.body`.** — desde el **26 ago 2026**.
...
**📊 Medición 2 sep: 6 activos desde el 27 ago** (Maria Adriana, Krishna, Constanza, Igna, Carolina, Mama). **Push de WhatsApp enviado el 2 sep a los 17 restantes.** **Próxima medición: viernes 4 sep.** 📲 **Instalaciones al 2 sep, según el Sheets de Daniel: 14 con la app puesta.** Google exige **12 simultáneos**, así que hoy el colchón es de **2**: si tres desinstalan, el reloj se reinicia. **Fuente de verdad de códigos: el Sheets de Daniel** — si el Sheets y este archivo difieren, gana el Sheets.
...
## Cerrado HOY — miércoles 2 septiembre 2026 — **El onboarding quedó cerrado en cinco frentes, y el primer encuentro dejó de inventar citas**
...
### ⬜ Lo que queda pendiente del onboarding

- **Bloque 3: el acto B guarda el episodio real.** Hoy el texto que escribe el padre o madre en el primer encuentro se usa para la respuesta y se pierde. Tiene que quedar como **el primer episodio de verdad** — es el principio rector: todo cuelga del momento.
- **Acto C.** Sin construir.
- **Pasada visual de Claude Design.** El brief ya se envió; **se está esperando los mockups**. Cuando lleguen, el handoff manda para ese cambio.

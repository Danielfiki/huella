...
2. **Empujar a los 4 registrados que NO canjearon su código** — `v.ramirez` (H-13), `javiera.zamora.r` (H-17), `ignacopardo` (H-15), `nene.pepita` (H-11). **Hipótesis fuerte: buscaron el bloque de canje en el inicio, donde ya no está** (se mudó a "Tú"). El recordatorio debe llevar la instrucción corregida.
3. **Seguimiento de la incidencia de `mariaadrianaq`** (ver el bloque del 29 ago).
...
| 13 | Igna | `ignacopardo@gmail.com` | H-15 | 🟡 **registrado, SIN canjear** |
...
## Cerrado HOY — domingo 30 agosto 2026 — **🔴 Se cazó el bug que dejaba la app pegada en el splash, y quedó con red de seguridad automatizada**
...
| 2 | "App not available" en el link de opt-in | 🔴 **ABIERTA** |
...
### 6. Caso Ignacia — ABIERTO, espera el SQL
...
- **11 códigos canjeados**, **todos de la lista oficial: cero intrusos.**
- **4 personas registradas SIN canjear:** `v.ramirez` (H-13), `javiera.zamora.r` (H-17), `ignacopardo` (H-15), `nene.pepita` (H-11) → **recordatorio en el empuje de la próxima semana**, con la instrucción corregida.

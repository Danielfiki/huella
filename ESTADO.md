...
## ⏭️ PRIORIDAD INMEDIATA (próxima sesión) — COMPLETAR LA CONVOCATORIA DE 20 TESTERS ANDROID (17/20 al 1 ago · lanzamiento domingo 9 ago)

**ESTADO AL 1 AGO 2026 (lo más nuevo, leer primero):** la meta subió de 15 a **20 testers** y van **17 correos**. **Ya se puede lanzar:** el tablero separa el **mínimo para partir (`MIN_CORREOS = 15`)** de la **meta ideal (`META_CORREOS = 20`)**, así que con 17 ya no frena. **Fecha de lanzamiento acordada: domingo 9 de agosto**; la beta termina el **domingo 23 de agosto**. Los **20 códigos `HUELLA-01..20` están libres** (verificado en Supabase; `HUELLA-01` NO estaba gastado). El tablero de `/beta` quedó limpio: contador correcto y advertencia obsoleta eliminada (commit `df9c130`). **El protocolo completo vive en `huella-protocolo-beta-android.md` (Drive, versión 1 ago)**, que reemplaza la versión del 24 jul y la guía vieja de la beta web con Tally.
...
1. **Completar la convocatoria de 20 testers Android** (van 17; con 15 ya se puede lanzar) vía la marca personal de Daniel (historia de Instagram con caja de preguntas pidiendo el Gmail). **Juntar TODOS los correos primero y soltar el link de opt-in el MISMO día** — Google exige **12 testers instalados SIMULTÁNEOS durante 14 días corridos, NO acumulados**; los 20 son el colchón sobre esos 12. Link de opt-in: `https://play.google.com/apps/testing/lat.huella.app`. **Protocolo completo (textos de convocatoria y mensajes): `huella-protocolo-beta-android.md`** (Drive, carpeta HUELLA, versión 1 ago), **documento único**: reemplaza la versión del 24 jul, el flujo PWA de `huella-textos-beta.md` y la guía vieja de la beta web con Tally.
...
## Cerrado HOY — sábado 1 agosto 2026 — El tablero de `/beta` queda listo para correr la beta completa: meta a 20, seguimiento por tester, pasos de los días 7 y 10, y mínimo para lanzar separado de la meta
...
- **Fecha de lanzamiento acordada: domingo 9 de agosto.** La beta termina el **domingo 23 de agosto** (14 días corridos).

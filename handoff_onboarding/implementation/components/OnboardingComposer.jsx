...
//
// La llamada a la API se hace en `requestPrimerEncuentro()` (importada de ../api/anthropic).
...
// ⚠️ Claude Code: ajustar el import según dónde quede el helper en el repo.
// Contrato esperado en README.md → sección "API · primer encuentro".
import { requestPrimerEncuentro } from '../../api/anthropic';

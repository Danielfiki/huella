...
const EMPTY_PERFIL = {
  ...
  sexo: null,        // 'Niño' | 'Niña' | 'Otro'
  fotoBlob: null,    // File · opcional
  intenciones: [],   // string[] del set fijo (ver OnboardingFormSlide)
  contextoInicial: null, // texto del slide 3 si lo escribió · opcional
};
